// To parse this data:
//
//   import { Convert, DragonBallZ } from "./file";
//
//   const dragonBallZ = Convert.toDragonBallZ(json);
//
...
export class Convert {
    public static toDragonBallZ(json: string): DragonBallZ {
        return cast(JSON.parse(json), r("DragonBallZ"));
    }

    public static dragonBallZToJson(value: DragonBallZ): string {
        return JSON.stringify(uncast(value, r("DragonBallZ")), null, 2);
    }
}
